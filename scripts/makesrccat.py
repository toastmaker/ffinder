...
def update_src_cat(src_name, src_ra, src_dec, new_fn, \
                  fn_template = "/Users/toast/Dropbox/inaf/repos/catalogs/FRBM81_ii_specat.fits"):
	with fits.open(fn_template) as hdu:
		...
		print("Updating source name and coordinates to: ", 	source['NAME'], source['RA_FIN'], source['DEC_FIN'])
		hdu.writeto(new_fn)
