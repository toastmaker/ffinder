...
Typical usage:
  ...
  ffinder2.py -v -o 2scw_flares_5s.csv -s 5.0 -P 3.0 0122/012200850010_evts_h.fits.gz
...
if __name__ == "__main__":
	try:
		opts, args = getopt.getopt(sys.argv[1:], "ho:vd:p:s:wP:N:Z", ["help", "output=","verbose","dir=","par=","sigma-threshold=","walltime","poisson-threshold=","nsigma=", "no-zero-mean"])
	...
	np.savetxt(fn_flares, flares_s.to_numpy(), fmt="%s  %4.2f  %12.8f  %7.2f  %7.2f  %4.2f  %7.2f  %12.8f  %5.2f  %5.2f  %5.1f  %5.1f  %5.1f  %5.1f  %6.1f  %4.3f  %i", header=" ".join(flares_s.columns.values),comments='')
